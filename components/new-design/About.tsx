            ...
            <div className="bg-stone-100 p-6 sm:p-8 relative">
              ...
              <div className="flex items-start justify-between gap-3 mb-2">
                <p className="text-base sm:text-lg text-gray-800 leading-relaxed flex-1">
                  Historicamente, artistas LGBTQIAPN+ enfrentam o apagamento de suas trajetórias e a invisibilização de suas obras. Em cidades do interior, essa realidade é ainda mais profunda, por falta de espaços de representatividade.
                </p>
                <AudioDescriptionButton
                  text="Historicamente, artistas LGBTQIAPN+ enfrentam o apagamento de suas trajetórias e a invisibilização de suas obras. Em cidades do interior, essa realidade é ainda mais profunda, por falta de espaços de representatividade."
