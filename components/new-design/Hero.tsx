            ...
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
              ...
              >
                ...
                <div className="relative w-full h-full">
                  ...
                  <motion.div
                    className="absolute bottom-32 -right-8 w-48 h-48 bg-yellow-400 rounded-full"
                    animate={{ scale: [1, 1.1, 1] }}
                    transition={{ duration: 3, repeat: Infinity, ease: "easeInOut" }}
                  />

                  <motion.div
                    className="absolute top-1/2 left-[70%] -translate-x-1/2 -translate-y-1/2 w-32 h-32 bg-orange-500"
                    animate={{ rotate: [0, 180, 360] }}
                    transition={{ duration: 8, repeat: Infinity, ease: "linear" }}
                  />

                  <motion.div
                    className="absolute bottom-20 left-44 w-24 h-64 bg-blue-600"
                    animate={{ x: [0, 10, 0] }}
