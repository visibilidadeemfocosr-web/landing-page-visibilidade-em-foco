...
import { Instagram, Facebook, Linkedin, Download, Edit2, Check, X, ChevronRight, Copy, Camera, FileText, Music, Palette, Film, BookOpen, Shirt, Activity, Theater, Sparkles, Mic } from 'lucide-react'
...
export default function AdminModeratePreviewClient() {
  ...
  const getLanguageIcon = (language: string | undefined) => {
    ...
    if (lang.includes('dança') || lang.includes('danca')) return <Activity className="w-6 h-6" />
